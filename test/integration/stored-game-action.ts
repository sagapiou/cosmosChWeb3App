...
import { StoredGame } from "../../src/types/generated/checkers/checkers/stored_game"
...
describe("StoredGame Action", function () {
    ...
    it("empty test game action", async function () {
        //console.log((await aliceSigner.getAccounts())[0].address)
        //console.log((await bobSigner.getAccounts())[0].address)
        //console.log(parseInt((await aliceClient.getBalance(alice, "token")).amount, 10))
        //console.log(parseInt((await bobClient.getBalance(bob, "token")).amount, 10))
    })
